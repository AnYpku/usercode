...
// Thu Apr 11 11:20:53 2013 by ROOT version 5.30/02
// from TTree EventTree/Event data
// found on file: /mnt/hadoop/user/uscms01/pnfs/unl.edu/data4/cms/store/user/eavdeeva2/WGammaMC/job_summer12_Wg.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           IsVtxGood;
   Int_t           nVtxBS;
   Float_t         vtxbs[70][3];   //[nVtxBS]
   Float_t         pdf[7];
   Float_t         pthat;
   Float_t         processID;
   Int_t           nMC;
   Int_t           mcPID[9];   //[nMC]
   Float_t         mcVtx[9][3];   //[nMC]
   Float_t         mcPt[9];   //[nMC]
   Float_t         mcMass[9];   //[nMC]
   Float_t         mcEta[9];   //[nMC]
   Float_t         mcPhi[9];   //[nMC]
   Float_t         mcE[9];   //[nMC]
   Float_t         mcEt[9];   //[nMC]
   Int_t           mcGMomPID[9];   //[nMC]
   Int_t           mcMomPID[9];   //[nMC]
   Float_t         mcMomPt[9];   //[nMC]
   Float_t         mcMomMass[9];   //[nMC]
   Float_t         mcMomEta[9];   //[nMC]
   Float_t         mcMomPhi[9];   //[nMC]
   Int_t           mcIndex[9];   //[nMC]
   Int_t           mcDecayType[9];   //[nMC]
   Float_t         genMET;
   Float_t         genMETPhi;
   Int_t           nPUInfo;
   Int_t           nPU[3];   //[nPUInfo]
   ...
   Float_t         eleIDMVATrigIDIso[9];   //[nEle]
   ...
   Int_t           nMu;
   Int_t           muTrg[14][10];   //[nMu]
   Float_t         muEta[14];   //[nMu]
   Float_t         muPhi[14];   //[nMu]
   Int_t           muCharge[14];   //[nMu]
   Float_t         muPt[14];   //[nMu]
   Float_t         muPz[14];   //[nMu]
   Float_t         muVtx[14][3];   //[nMu]
   Float_t         muVtxGlb[14][3];   //[nMu]
   Int_t           muGenIndex[14];   //[nMu]
   Float_t         mucktPt_[14];   //[nMu]
   Float_t         mucktPtErr_[14];   //[nMu]
   Float_t         mucktdxy_[14];   //[nMu]
   Float_t         mucktdz_[14];   //[nMu]
   Float_t         muIsoTrk[14];   //[nMu]
   Float_t         muIsoCalo[14];   //[nMu]
   Float_t         muIsoEcal[14];   //[nMu]
   Float_t         muIsoHcal[14];   //[nMu]
   Float_t         muChi2NDF[14];   //[nMu]
   Float_t         muInnerChi2NDF[14];   //[nMu]
   Float_t         muPFIsoR04_CH[14];   //[nMu]
   Float_t         muPFIsoR04_NH[14];   //[nMu]
   Float_t         muPFIsoR04_Pho[14];   //[nMu]
   Float_t         muPFIsoR04_PU[14];   //[nMu]
   Float_t         muPFIsoR04_CPart[14];   //[nMu]
   Float_t         muPFIsoR04_NHHT[14];   //[nMu]
   Float_t         muPFIsoR04_PhoHT[14];   //[nMu]
   Float_t         muPFIsoR03_CH[14];   //[nMu]
   Float_t         muPFIsoR03_NH[14];   //[nMu]
   Float_t         muPFIsoR03_Pho[14];   //[nMu]
   Float_t         muPFIsoR03_PU[14];   //[nMu]
   Float_t         muPFIsoR03_CPart[14];   //[nMu]
   Float_t         muPFIsoR03_NHHT[14];   //[nMu]
   Float_t         muPFIsoR03_PhoHT[14];   //[nMu]
   Int_t           muType[14];   //[nMu]
   Bool_t          muID[14][6];   //[nMu]
   Float_t         muD0[14];   //[nMu]
   Float_t         muDz[14];   //[nMu]
   Float_t         muD0GV[14];   //[nMu]
   Float_t         muDzGV[14];   //[nMu]
   Float_t         muD0Vtx[14][100];   //[nMu]
   Float_t         muDzVtx[14][100];   //[nMu]
   Float_t         muInnerD0[14];   //[nMu]
   Float_t         muInnerDz[14];   //[nMu]
   Float_t         muInnerD0GV[14];   //[nMu]
   Float_t         muInnerDzGV[14];   //[nMu]
   Int_t           muNumberOfValidTrkLayers[14];   //[nMu]
   Int_t           muNumberOfValidTrkHits[14];   //[nMu]
   Int_t           muNumberOfValidPixelLayers[14];   //[nMu]
   Int_t           muNumberOfValidPixelHits[14];   //[nMu]
   Int_t           muNumberOfValidMuonHits[14];   //[nMu]
   Int_t           muStations[14];   //[nMu]
   Int_t           muChambers[14];   //[nMu]
   Float_t         muIP3D[14];   //[nMu]
   Float_t         muIP3DErr[14];   //[nMu]
   Int_t           nPFEle_;
   ...
   Int_t           nLowPtJet;
   Float_t         jetLowPtEn[64];   //[nLowPtJet]
   Float_t         jetLowPtPt[64];   //[nLowPtJet]
   Float_t         jetLowPtEta[64];   //[nLowPtJet]
   Float_t         jetLowPtPhi[64];   //[nLowPtJet]
   Float_t         jetLowPtCharge[64];   //[nLowPtJet]
   Float_t         jetLowPtEt[64];   //[nLowPtJet]
   Float_t         jetLowPtRawPt[64];   //[nLowPtJet]
   Float_t         jetLowPtRawEn[64];   //[nLowPtJet]
   Float_t         jetLowPtArea[64];   //[nLowPtJet]
   Int_t           jetLowPtPartonID[64];   //[nLowPtJet]
   Float_t         jetLowPtGenJetEn[64];   //[nLowPtJet]
   Float_t         jetLowPtGenJetPt[64];   //[nLowPtJet]
   Float_t         jetLowPtGenJetEta[64];   //[nLowPtJet]
   Float_t         jetLowPtGenJetPhi[64];   //[nLowPtJet]
   Int_t           jetLowPtGenPartonID[64];   //[nLowPtJet]
   Float_t         jetLowPtGenEn[64];   //[nLowPtJet]
   Float_t         jetLowPtGenPt[64];   //[nLowPtJet]
   Float_t         jetLowPtGenEta[64];   //[nLowPtJet]
   Float_t         jetLowPtGenPhi[64];   //[nLowPtJet]
   Int_t           nConv;
   Float_t         convP4[120][4];   //[nConv]
   Float_t         convVtx[120][3];   //[nConv]
   Float_t         convVtxErr[120][3];   //[nConv]
   Float_t         convPairMomentum[120][3];   //[nConv]
   Float_t         convRefittedMomentum[120][3];   //[nConv]
   Int_t           convNTracks[120];   //[nConv]
   Float_t         convPairInvMass[120];   //[nConv]
   Float_t         convPairCotThetaSep[120];   //[nConv]
   Float_t         convEoverP[120];   //[nConv]
   Float_t         convDistOfMinApproach[120];   //[nConv]
   Float_t         convDPhiTrksAtVtx[120];   //[nConv]
   Float_t         convDPhiTrksAtEcal[120];   //[nConv]
   Float_t         convDEtaTrksAtEcal[120];   //[nConv]
   Float_t         convDxy[120];   //[nConv]
   Float_t         convDz[120];   //[nConv]
   Float_t         convLxy[120];   //[nConv]
   Float_t         convLz[120];   //[nConv]
   Float_t         convZofPrimVtxFromTrks[120];   //[nConv]
   Int_t           convNHitsBeforeVtx[120][2];   //[nConv]
   Int_t           convNSharedHits[120];   //[nConv]
   Int_t           convValidVtx[120];   //[nConv]
   Float_t         convMVALikelihood[120];   //[nConv]
   Float_t         convChi2[120];   //[nConv]
   Float_t         convChi2Probability[120];   //[nConv]
   Float_t         convTk1Dz[120];   //[nConv]
   Float_t         convTk2Dz[120];   //[nConv]
   Float_t         convTk1DzErr[120];   //[nConv]
   Float_t         convTk2DzErr[120];   //[nConv]
   Int_t           convCh1Ch2[120];   //[nConv]
   Float_t         convTk1D0[120];   //[nConv]
   Float_t         convTk1Pout[120];   //[nConv]
   Float_t         convTk1Pin[120];   //[nConv]
   Float_t         convTk2D0[120];   //[nConv]
   Float_t         convTk2Pout[120];   //[nConv]
   Float_t         convTk2Pin[120];   //[nConv]
...
#ifdef TInputTree_cxx
TInputTree::TInputTree(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
//   if (tree == 0) {
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/hadoop/user/uscms01/pnfs/unl.edu/data4/cms/store/user/eavdeeva2/WGammaMC/job_summer12_Wg.root");
//      if (!f || !f->IsOpen()) {
//         f = new TFile("/mnt/hadoop/user/uscms01/pnfs/unl.edu/data4/cms/store/user/eavdeeva2/WGammaMC/job_summer12_Wg.root");
//      }
//      TDirectory * dir = (TDirectory*)f->Get("/mnt/hadoop/user/uscms01/pnfs/unl.edu/data4/cms/store/user/eavdeeva2/WGammaMC/job_summer12_Wg.root:/ggNtuplizer");
...
TInputTree::~TInputTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TInputTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TInputTree::LoadTree(Long64_t entry)
{
...
void TInputTree::Init(TTree *tree)
{
...
void TInputTree::Show(Long64_t entry)
{
...
Int_t TInputTree::Cut(Long64_t entry)
{
