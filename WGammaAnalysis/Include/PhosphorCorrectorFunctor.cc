...
double zgamma::PhosphorCorrectionFunctor::GetCorrEnergyMC(int year, double pt, double etaReco, double Egen){
...
double zgamma::PhosphorCorrectionFunctor::GetCorrEnergyMC(float R9, int year, double pt, double etaReco, double Egen){
...
double zgamma::PhosphorCorrectionFunctor::GetCorrEnergyData(int year, double pt, double etaReco){
...
double zgamma::PhosphorCorrectionFunctor::GetCorrEnergyData(float R9, int year, double pt, double etaReco){
...
double zgamma::PhosphorCorrectionFunctor::GetCorrEtMC(int year, double pt, double etaReco, double Egen){
...
double zgamma::PhosphorCorrectionFunctor::GetCorrEtMC(float R9, int year, double pt, double etaReco, double Egen){
...
double zgamma::PhosphorCorrectionFunctor::GetCorrEtData(int year, double pt, double etaReco){
...
double zgamma::PhosphorCorrectionFunctor::GetCorrEtData(float R9, int year, double pt, double etaReco){
...
int zgamma::PhosphorCorrectionFunctor::GetCategory(float R9, int year, double pt, double etaReco){
...
/*
  pair <int,double> zgamma::PhosphorCorrectionFunctor::ScaleEnError(float R9, int year, double pt, double etaReco, double Egen){
...
pair <int,double> zgamma::PhosphorCorrectionFunctor::ResEnError(float R9, int year, double pt, double etaReco, double Egen){
...
bool zgamma::PhosphorCorrectionFunctor::MapCat(){
  //map<int, int> Map;
...
int zgamma::PhosphorCorrectionFunctor::GetCatNumber(int index){
  
  if( CatMap[index] >= 0 && CatMap[index] <= 24 )return CatMap[index];
  return -66;
};
int* zgamma::PhosphorCorrectionFunctor::CatIndex(float R9, int year, double pt, double etaReco){
